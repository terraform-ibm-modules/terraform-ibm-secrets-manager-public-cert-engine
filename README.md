...
[![Terraform Registry](https://img.shields.io/badge/terraform-registry-623CE4?logo=terraform)](https://registry.terraform.io/modules/terraform-ibm-modules/secrets-manager-public-cert-engine/ibm/latest)
...
## Overview
<ul>
  <li><a href="#terraform-ibm-secrets-manager-public-cert-engine">terraform-ibm-secrets-manager-public-cert-engine</a></li>
  <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-secrets-manager-public-cert-engine/tree/main/examples">Examples</a>
    <ul>
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-secrets-manager-public-cert-engine/tree/main/examples/api_key_auth">Secrets Manager public certificate engine using API key authentication</a>
      ...
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-secrets-manager-public-cert-engine/tree/main/examples/iam_auth">Secrets Manager public certificate engine using an IBM IAM authorization policy</a>
  ...
  <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-secrets-manager-public-cert-engine/tree/main/solutions">Deployable Architectures</a>
    <ul>
      <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-secrets-manager-public-cert-engine/tree/main/solutions/fully-configurable">Cloud automation for Secrets Manager public certificates engine (Fully configurable)</a></li>
    </ul>
  </li>
